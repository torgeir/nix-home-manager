...
in
{
  ...
  options.programs.t-doomemacs.enable = lib.mkEnableOption "Enable doom emacs configuration.";
  ...
  config = lib.mkIf cfg.enable {
    ...
    xdg.configFile = {
      ...
      "doom.d".source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.doom.d";
      "emacs" = {
