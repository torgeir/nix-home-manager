...
let
  cfg = config.programs.t-terminal.ghostty;
in
{

  options.programs.t-terminal.ghostty.enable = lib.mkEnableOption "Enable ghostty configuration.";

  options.programs.t-terminal.ghostty.package = lib.mkPackageOption pkgs "ghostty" {
    default = "ghostty";
    example = "pkgs.unstable.ghostty";
  };
